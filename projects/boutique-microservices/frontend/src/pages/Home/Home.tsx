              ...
              <Slide in timeout={1500} direction="right">
                <Box
                  sx={{
                    ...
                    background: (theme) => `linear-gradient(45deg, ${theme.palette.secondary.main} 0%, ${theme.palette.secondary.light} 100%)`,
                    borderRadius: 4,
                    display: 'flex',
                    alignItems: 'center',
        ...
        <Box sx={{ py: 8 }}>
          <Grid container spacing={4}>
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              ...
              >
                <ShippingIcon sx={{ fontSize: 48, color: (theme) => theme.palette.secondary.main, mb: 2 }} />
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              ...
              >
                <SecurityIcon sx={{ fontSize: 48, color: (theme) => theme.palette.secondary.main, mb: 2 }} />
                <Typography variant="h6" gutterBottom>
                  Secure Payment
                </Typography>
                <Typography variant="body2" color="text.secondary">
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              ...
              >
                <StarIcon sx={{ fontSize: 48, color: (theme) => theme.palette.secondary.main, mb: 2 }} />
                <Typography variant="h6" gutterBottom>
                  Premium Quality
                </Typography>
                <Typography variant="body2" color="text.secondary">
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              ...
              >
                <RefreshIcon sx={{ fontSize: 48, color: (theme) => theme.palette.secondary.main, mb: 2 }} />
                <Typography variant="h6" gutterBottom>
                  Easy Returns
                </Typography>
                <Typography variant="body2" color="text.secondary">
