    ...
    return (
      <Container maxWidth="md">
        <Box sx={{ py: 8, textAlign: 'center' }}>
          <ShoppingBagIcon sx={{ fontSize: 80, color: (theme) => theme.palette.secondary.main, mb: 3 }} />
            ...
            <Paper elevation={2} sx={{ p: 3, position: 'sticky', top: 24 }}>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: 700, color: (theme) => theme.palette.secondary.main }}>
